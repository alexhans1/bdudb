...
ngFileUpload.service('UploadValidate', [
  ...
  function(UploadDataUrl, $q, $timeout) {
    ...
    upload.validate = function(files, prevLength, ngModel, attr, scope) {
      ...
      var runAllValidation = upload.attrGetter(
      ...
      function validateSync(name, validationName, fn) {
        if (files) {
          ...
          while (i--) {
            var file = files[i];
            if (file) {
              var val = upload.getValidationAttr(
                attr,
                scope,
                name,
                validationName,
      ...
      promises.push(
        validateAsync('ratio', null, /image/, this.imageDimensions, function(
          d,
          val,
        ) {
...
(function() {
  ...
  function linkDrop(
    ...
    function extractFilesFromHtml(updateOn, html) {
      ...
      var urls = [];
      html.replace(/<(img src|img [^>]* src) *=\"([^\"]*)\"/gi, function(
        m,
        n,
        src,
      ) {
