    ...
    a('open', function(a) {
      return function(b, d, e) {
        ...
        try {
          ...
          f.message.indexOf('Access is denied') > -1 &&
            ((this.__origError = f),
            a.apply(this, [b, '_fix_for_ie_crossdomain__', e]));
        }
      };
    }),
      a('getResponseHeader', function(a) {
        return function(b) {
          return this.__fileApiXHR && this.__fileApiXHR.getResponseHeader
            ? this.__fileApiXHR.getResponseHeader(b)
            : null == a
            ? null
            : a.apply(this, [b]);
        };
              ...
              e = {
                ...
                complete: function(a, d) {
                  a &&
                    ...
                    void 0 !== d.status &&
                      b(c, 'status', function() {
                        return 0 === d.status && a && 'abort' !== a
                          ? 500
                          : d.status;
                      }),
                    void 0 !== d.statusText &&
                      b(c, 'statusText', function() {
                        return d.statusText;
                      }),
      ...
      (window.FormData = FormData = function() {
        return {
          append: function(a, b, c) {
            b.__isFileAPIBlobShim && (b = b.data[0]),
    ...
    if (FileAPI.shouldLoad) {
      if (
        ...
        if (window.FileAPI.jsUrl) d = window.FileAPI.jsUrl;
          ...
          for (f = 0; f < j.length; f++)
            if (
              ((h = j[f].src),
              (g = h.search(/\/ng\-file\-upload[\-a-zA-z0-9\.]*\.js/)),
              g > -1)
            ) {
              e = h.substring(0, g + 1);
              break;
            }
        null == FileAPI.staticPath && (FileAPI.staticPath = e),
          i.setAttribute('src', d || e + 'FileAPI.min.js'),
      ...
      (FileAPI.ngfFixIE = function(d, e, f) {
        ...
        var g = function() {
          var b = e.parent();
          d.attr('disabled')
            ? b && b.removeClass('js-fileapi-wrapper')
            : (e.attr('__ngf_flash_') ||
                (e.unbind('change'),
                e.unbind('click'),
                ...
                e.attr('__ngf_flash_', 'true')),
              b.addClass('js-fileapi-wrapper'),
              a(d) ||
                (b
                  .css('position', 'absolute')
                  .css('top', c(d[0]).top + 'px')
                  .css('left', c(d[0]).left + 'px')
                  .css('width', d[0].offsetWidth + 'px')
                  .css('height', d[0].offsetHeight + 'px')
                  .css('filter', 'alpha(opacity=0)')
                  .css('display', d.css('display'))
                  .css('overflow', 'hidden')
                  .css('z-index', '900000')
        ...
        var h = function(a) {
          for (var b = FileAPI.getFiles(a), c = 0; c < b.length; c++)
            void 0 === b[c].size && (b[c].size = 0),
              void 0 === b[c].name && (b[c].name = 'file'),
              void 0 === b[c].type && (b[c].type = 'undefined');
          a.target || (a.target = {}),
            (a.target.files = b),
            a.target.files !== b && (a.__files_ = b),
        ...
        (FileAPI.disableFileInput = function(a, b) {
          b
            ? a.removeClass('js-fileapi-wrapper')
            : a.addClass('js-fileapi-wrapper');
        });
    }
  })(),
  window.FileReader ||
