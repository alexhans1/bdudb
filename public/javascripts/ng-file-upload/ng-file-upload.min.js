...
!window.XMLHttpRequest ||
  ...
  (window.XMLHttpRequest.prototype.setRequestHeader = (function(a) {
    return function(b, c) {
      if ('__setXHR_' === b) {
        var d = c(this);
...
(ngFileUpload.version = '12.2.13'),
    ...
    function(a, b, c) {
      function d(d) {
        ...
        return (
          ...
          g
            ? d._chunkSize && d._end && !d._finished
              ? ((d._start = d._end), (d._end += d._chunkSize), i())
              : d.resumeSizeUrl
              ? a.get(d.resumeSizeUrl).then(
                  function(a) {
                    (d._start = d.resumeSizeResponseReader
                      ? d.resumeSizeResponseReader(a.data)
                      : parseInt(
                          (null == a.data.size
                            ? a.data
                            : a.data.size
              ...
              : (d._chunkSize &&
                  ((d._start = 0), (d._end = d._start + d._chunkSize)),
                i())
            : i(),
      ...
      (this.isUploadInProgress = function() {
        ...
        (this.isFile = function(a) {
          return (
            null != a &&
            (a instanceof window.Blob || (a.flashId && a.name && a.size))
          );
        }),
        (this.upload = function(a, b) {
          function c(b, c) {
            ...
            if (((a._file = a._file || b), null != a._start && g)) {
              a._end &&
                a._end >= b.size &&
                ((a._finished = !0), (a._end = b.size));
              var d = b.slice(a._start, a._end || b.size);
              return (
                (d.name = b.name),
                (d.ngfName = b.ngfName),
                a._chunkSize &&
                  (c.append('_chunkSize', a._chunkSize),
          ...
          function h(b, d, e) {
            if (void 0 !== d)
              if (
                (angular.isDate(d) && (d = d.toISOString()),
                angular.isString(d))
              )
                b.append(e, d);
              else if (f.isFile(d)) {
                var g = c(d, b),
                  i = e.split(',');
                i[1] &&
                  ((g.ngfName = i[1].replace(/^\s+|\s+$/g, '')), (e = i[0])),
                ...
                try {
                  for (var j in d)
                    if (d.hasOwnProperty(j) && '$$ngfCircularDetection' !== j) {
                      ...
                      d.length &&
                        parseInt(j) > -1 &&
                        (k = null == a.arrayKey ? k : a.arrayKey),
          ...
          function i() {
            (a._chunkSize = f.translateScalars(a.resumeChunkSize)),
              (a._chunkSize = a._chunkSize
                ? parseInt(a._chunkSize.toString())
                : null),
              (a.headers = a.headers || {}),
              (a.headers['Content-Type'] = void 0),
              (a.transformRequest = a.transformRequest
                ? angular.isArray(a.transformRequest)
                  ? a.transformRequest
                  : [a.transformRequest]
                : []),
          ...
          return (
            b || (a = e(a)), a._isDigested || ((a._isDigested = !0), i()), d(a)
          );
        }),
            ...
            (b.transformRequest =
              ...
              function(b) {
                return (window.ArrayBuffer &&
                  ...
                  b instanceof window.Blob
                  ? b
                  : a.defaults.transformRequest[0].apply(this, arguments);
              }),
            (b._chunkSize = f.translateScalars(b.resumeChunkSize)),
            (b._chunkSize = b._chunkSize
              ? parseInt(b._chunkSize.toString())
              : null),
            d(b)
          );
        }),
        ...
        (this.urlToBlob = function(c) {
          var d = b.defer();
          return (
            a({ url: c, method: 'get', responseType: 'arraybuffer' }).then(
              function(a) {
  ...
  ngFileUpload.service('Upload', [
    ...
    function(a, b, c, d, e) {
      function f(a, b, c) {
        ...
        return (
          angular.forEach(a, function(d, f) {
            0 === d.type.indexOf('image/jpeg') &&
              i.attrGetter('ngfFixOrientation', b, c, { $file: d }) &&
              e.push(
                i.happyPromise(i.applyExifRotation(d), d).then(function(b) {
                  a.splice(f, 1, b);
                }),
              );
          }),
                ...
                function(a) {
                  (d.$error = 'resize'),
                    ...
                    (d.$errorParam =
                      ...
                      (d && d.name)),
                    f.$ngfValidations.push({ name: 'resize', valid: !1 }),
      ...
      var i = e;
      return (
        (i.getAttrWithDefaults = function(a, b) {
        ...
        (i.updateModel = function(c, d, e, h, j, k, l) {
          function m(f, g, j, l, m) {
            ...
            c && (i.applyModelValidation(c, f), c.$setViewValue(m ? n : f)),
              h &&
                a(h)(e, {
                  $files: f,
                  $file: n,
          ...
          function n() {
            function a(a, b) {
              return (
                a.name === b.name &&
                (a.$ngfOrigSize || a.size) === (b.$ngfOrigSize || b.size) &&
                a.type === b.type
              );
            }
            function b(b) {
          ...
          function p() {
            ...
            g(f, d, e, c).then(
              function() {
                y
                  ? i.validate(q, w ? r.length : 0, c, d, e).then(function(b) {
          ...
          (q = (j || []).slice(0)),
            ('distinct' === w ||
              i.attrGetter('ngfKeepDistinct', d, e) === !0) &&
              n(d, e);
          var x =
            !w &&
            !i.attrGetter('ngfMultiple', d, e) &&
            !i.attrGetter('multiple', d);
          if (!w || q.length) {
            ...
            i.validate(q, w ? r.length : 0, c, d, e).then(function(a) {
              l
                ...
                : ((z && z.allowInvalid) || y
                    ? (v = q)
                    : ((v = a.validFiles), (u = a.invalidFiles)),
                  i.attrGetter('ngfFixOrientation', d, e) && i.isExifSupported()
                    ? f(v, d, e).then(function() {
                        p();
                      })
                    : p());
            });
    ...
    function(a, b, c, d) {
      function e(a) {
        ...
        if (b && b.length > 2) {
          ...
          return (
            parseInt(b[1]) < 4 || (parseInt(b[1]) === c && parseInt(b[2]) < c)
          );
        }
      ...
      function f(a, b, c, d, f, h, i, j) {
        ...
        function n(a, d) {
          ...
          for (var f = 0; f < b[0].attributes.length; f++) {
            ...
            'type' !== g.name &&
              ...
              'style' !== g.name &&
              ('id' === g.name
                ? (e(g.value), u.push(c.$observe('id', e)))
                : a.attr(
                    g.name,
                    g.value || ('required' !== g.name && 'multiple' !== g.name)
                      ? g.value
                      : g.name,
                  ));
          }
        ...
        function p(c) {
          ...
          if (!t('ngfSelectDisabled', a)) {
            ...
            try {
              k() ||
                document.body.contains(x[0]) ||
                (g.push({ el: b, ref: x.parent() }),
        ...
        function r(b) {
          j.shouldUpdateOn('click', c, a) &&
            x.val() &&
            (x.val(null), j.updateModel(d, c, a, l(), null, b, !0));
        }
        function s(a) {
        ...
        t('ngfMultiple') &&
          u.push(
            a.$watch(t('ngfMultiple'), function() {
              x.attr('multiple', t('ngfMultiple', a));
            }),
          ),
          t('ngfCapture') &&
            u.push(
              a.$watch(t('ngfCapture'), function() {
                x.attr('capture', t('ngfCapture', a));
              }),
            ),
          t('ngfAccept') &&
            u.push(
              a.$watch(t('ngfAccept'), function() {
        ...
        k() || (x = o()),
          ...
          h(function() {
            for (var a = 0; a < g.length; a++) {
              var b = g[a];
              document.body.contains(b.el[0]) ||
                (g.splice(a, 1), b.ref.remove());
            }
          }),
          window.FileAPI &&
            window.FileAPI.ngfFixIE &&
            window.FileAPI.ngfFixIE(b, x, m);
      }
      var g = [];
      return {
        restrict: 'AEC',
  ...
  (function() {
    function a(a) {
      return 'img' === a.tagName.toLowerCase()
        ? 'image'
        : 'audio' === a.tagName.toLowerCase()
        ? 'audio'
        : 'video' === a.tagName.toLowerCase()
        ? 'video'
        : /./;
    }
      ...
      c(function() {
        var c = d.$watch(f[g], function(c) {
          ...
          if (
            ...
            l.width &&
              l.width.indexOf('px') > -1 &&
              l.height &&
              l.height.indexOf('px') > -1 &&
              (k = {
                width: parseInt(l.width.slice(0, -2)),
                height: parseInt(l.height.slice(0, -2)),
              });
          }
          return angular.isString(c)
            ...
            : void (!c ||
              !c.type ||
              0 !== c.type.search(a(e[0])) ||
              (i && 0 !== c.type.indexOf('image'))
                ? e.addClass('ng-hide')
                : k && b.isResizeSupported()
                ? ((k.resizeIf = function(a, e) {
        ...
        return (
          ...
          (d.dataUrl = function(a, e) {
            ...
            return (
                    ...
                    b(function() {
                      if (((a.$ngfBlobUrl = f), f)) {
                        g.resolve(f, a),
                          ...
                          d.blobUrls.push({ url: f, size: a.size }),
                          (d.blobUrlsTotalSize += a.size || 0);
                        for (
                          var b = d.defaults.blobUrlsMaxMemory || 268435456,
                            e = d.defaults.blobUrlsMaxQueueSize || 200;
                          (d.blobUrlsTotalSize > b || d.blobUrls.length > e) &&
                          d.blobUrls.length > 1;
              ...
              (f = e
                ? (a.$$ngfDataUrlPromise = g.promise)
                : (a.$$ngfBlobUrlPromise = g.promise)),
              f['finally'](function() {
          ...
          return {
            ...
            link: function(d, e, f) {
              ...
              b(
                ...
                'ngfThumbnail',
                g,
                a.attrGetter('ngfAsBackground', f, d),
              );
            },
          };
        },
          ...
          return function(c, d, e) {
            ...
            return c && !f
              ? (!c.$ngfDataUrlFilterInProgress &&
                  angular.isObject(c) &&
                  ((c.$ngfDataUrlFilterInProgress = !0), a.dataUrl(c, d)),
                '')
  ...
  ngFileUpload.service('UploadValidate', [
    ...
    function(a, b, c) {
        ...
        if (a.length > 2 && '/' === a[0] && '/' === a[a.length - 1])
          ...
          if (e.length > 1)
            for (var f = 0; f < e.length; f++) {
              var g = d(e[f]);
              g.regexp
                ? ((b += '(' + g.regexp + ')'), f < e.length - 1 && (b += '|'))
                : (c = c.concat(g.excludes));
            }
          else
            0 === a.indexOf('!')
              ? c.push('^((?!' + d(a.substring(1)).regexp + ').)*$')
              : (0 === a.indexOf('.') && (a = '*' + a),
                (b =
                  '^' +
                  a.replace(
      ...
      function e(a, b) {
        null == b ||
          a.$dirty ||
          (a.$setDirty ? a.$setDirty() : (a.$dirty = !0));
      }
      var f = a;
      return (
        (f.validatePattern = function(a, b) {
          if (!b) return !0;
          var c = d(b),
            e = !0;
          if (c.regexp && c.regexp.length) {
            ...
            e =
              (null != a.type && f.test(a.type)) ||
              (null != a.name && f.test(a.name));
          }
          for (var g = c.excludes.length; g--; ) {
            var h = new RegExp(c.excludes[g], 'i');
            e =
              e &&
              (null == a.type || h.test(a.type)) &&
              (null == a.name || h.test(a.name));
          }
          return e;
        }),
        (f.ratioToFloat = function(a) {
          ...
          return (b =
            c > -1
              ? parseFloat(b.substring(0, c)) / parseFloat(b.substring(c + 1))
              : parseFloat(b));
        }),
        (f.registerModelChangeValidator = function(a, b, c) {
          a &&
            a.$formatters.push(function(d) {
              if (a.$dirty) {
                var e = d;
        ...
        (f.getValidationAttr = function(a, b, c, d, e) {
          var g = 'ngf' + c[0].toUpperCase() + c.substr(1),
            h = f.attrGetter(g, a, b, { $file: e });
          if (
            null == h &&
            (h = f.attrGetter('ngfValidate', a, b, { $file: e }))
          ) {
            var i = (d || c).split('.');
        ...
        (f.validate = function(a, c, d, e, g) {
          ...
          function i(c, h, i, n, o) {
            ...
            a &&
              ...
              angular.forEach(a, function(a) {
                ...
                return (
                  q.push(d.promise),
                  !i || (null != a.type && 0 === a.type.search(i))
                    ? void ('dimensions' === c &&
                      null != f.attrGetter('ngfDimensions', e)
                        ? f.imageDimensions(a).then(
                            function(b) {
                              p(
                                d,
                                a,
                        ...
                        : 'duration' === c &&
                          null != f.attrGetter('ngfDuration', e)
                        ? f.mediaDuration(a).then(
                            function(b) {
                              p(
                                d,
                                a,
                                j('ngfDuration', { $file: a, $duration: b }),
                              );
                            },
                            function() {
                              d.resolve(!1);
                        ...
                        : p(d, a, f.getValidationAttr(e, g, c, h, a)))
                    : void d.resolve(!0)
                );
              }));
            var r = b.defer();
            return (
              b.all(q).then(function(a) {
          ...
          h('pattern', null, f.validatePattern),
            h('minSize', 'size.min', function(a, b) {
              return a.size + 0.1 >= f.translateScalars(b);
            }),
          ...
          var n = 0;
          if (
            (h('maxTotalSize', null, function(b, c) {
              return (
                (n += b.size),
                n > f.translateScalars(c) ? (a.splice(0, a.length), !1) : !0
              );
            }),
            ...
            return f.emptyPromise({ validFiles: [], invalidFiles: m });
          var o = b.defer(),
            p = [];
          return (
            p.push(
            ...
            p.push(
              i('ratio', null, /image/, this.imageDimensions, function(a, b) {
                for (
                  var c = b.toString().split(','), d = !1, e = 0;
                  e < c.length;
                  e++
                )
                  Math.abs(a.width / a.height - f.ratioToFloat(c[e])) < 0.01 &&
                    (d = !0);
                return d;
              }),
            ),
          ...
          return (
            c(function() {
              return 0 !== a.type.indexOf('image')
                ? void e.reject('not image')
                : void f.dataUrl(a).then(
                    function(b) {
                      function d() {
        ...
        (f.mediaDuration = function(a) {
          ...
          return (
            c(function() {
              return 0 !== a.type.indexOf('audio') &&
                0 !== a.type.indexOf('video')
                ? void e.reject('not media')
                : void f.dataUrl(a).then(
                    function(b) {
                      function d() {
                        var b = h[0].duration;
                      ...
                      function g() {
                        c(function() {
                          h[0].parentNode &&
                            (h[0].duration ? d() : i > 10 ? f() : g());
                        }, 1e3);
                      }
                      var h = angular
                        .element(
                          0 === a.type.indexOf('audio') ? '<audio>' : '<video>',
                        )
                        .attr('src', b)
                        .css('visibility', 'none')
                        .css('position', 'fixed');
  ...
  ngFileUpload.service('UploadResize', [
    ...
    function(a, b) {
          ...
          return (
            ...
            (n.onload = function() {
              ...
              try {
                ...
                r.drawImage(
                  n,
                  Math.min(0, -q.marginX / 2),
                  Math.min(0, -q.marginY / 2),
                  q.width,
                  q.height,
                ),
                  l.resolve(m.toDataURL(h || 'image/WebP', g || 0.934));
              } catch (s) {
                l.reject(s);
              }
            }),
      ...
      return (
        (c.dataUrltoBlob = function(a, b, c) {
          for (
            var d = a.split(','),
              e = d[0].match(/:(.*?);/)[1],
              f = atob(d[1]),
        ...
        (c.isResizeSupported = function() {
          ...
          return (
            window.atob && a.getContext && a.getContext('2d') && window.Blob
          );
        }),
        c.isResizeSupported() &&
  ...
  (function() {
    function a(a, c, d, e, f, g, h, i, j, k) {
      ...
      function m(b, c, d) {
        if (b) {
          ...
          q(
            ...
            b.files,
            s('ngfAllowDir', a) !== !1,
            s('multiple') || s('ngfMultiple', a),
          ).then(function(a) {
            a.length
              ? n(a, c)
              : o(d, e).then(function(a) {
                  n(a, c);
                });
          });
        }
      ...
      function o(b, c) {
        ...
        var e = [];
        c.replace(/<(img src|img [^>]* src) *=\"([^\"]*)\"/gi, function(
          a,
          b,
          c,
        ) {
      ...
      function p(a, b, c, d) {
        var e = s('ngfDragOverClass', a, { $event: c }),
          f = 'dragover';
        if (angular.isString(e)) f = e;
          ...
          if (null != g && g.length)
            for (
              var h = e.pattern || s('ngfPattern', a, { $event: c }),
                j = g.length;
              j--;
      ...
      function q(b, c, e, f) {
                      ...
                      try {
                        e.length
                          ? ((h = h.concat(
                            ...
                            p())
                          : (angular.forEach(h.slice(0), function(c) {
                              n.length <= j &&
                                l >= o &&
                                d.push(g(c, (b ? b : '') + a.name + '/'));
                            }),
                            k.all(d).then(
                              function() {
                                c.resolve();
        ...
        if (b && b.length > 0 && 'file:' !== h.location.protocol)
          for (var q = 0; q < b.length; q++) {
            if (
              b[q].webkitGetAsEntry &&
              b[q].webkitGetAsEntry() &&
              b[q].webkitGetAsEntry().isDirectory
            ) {
          ...
          for (var u = 0; u < c.length; u++) {
            var v = c.item(u);
            if (
              ((v.type || v.size > 0) && (n.push(v), (o += v.size)),
      ...
      if (
        (s('dropAvailable') &&
          g(function() {
            a[s('dropAvailable')]
              ? (a[s('dropAvailable')].value = r)
              : (a[s('dropAvailable')] = r);
          }),
        !r)
      )
        return void (
          s('ngfHideOnDropNotAvailable', a) === !0 && c.css('display', 'none')
        );
      ...
      c[0].addEventListener(
            ...
            g.cancel(u),
              t ||
                ...
                p(a, d, b, function(d) {
                  (t = d),
                    c.addClass(t),
                    s('ngfDrag', a, { $isDragging: !0, $class: t, $event: b });
                }));
          }
        },
        !1,
        ...
        c[0].addEventListener(
          ...
          function(b) {
            !l() &&
              i.shouldUpdateOn('drop', d, a) &&
              (b.preventDefault(), v(a) && b.stopPropagation());
          },
          !1,
        ),
        c[0].addEventListener(
          ...
          function(b) {
            !l() &&
              ...
              (u = g(function() {
                t && c.removeClass(t),
                  (t = null),
                  s('ngfDrag', a, { $isDragging: !1, $event: b });
              }, w || 100)));
          },
          !1,
        ),
        ...
        c[0].addEventListener(
          ...
          function(b) {
            navigator.userAgent.toLowerCase().indexOf('firefox') > -1 &&
              s('ngfEnableFirefoxPaste', a) &&
              b.preventDefault(),
              !l() &&
                i.shouldUpdateOn('paste', d, a) &&
                m(
  ...
  ngFileUpload.service('UploadExif', [
    ...
    function(a, b) {
      ...
      function d(a) {
        for (
          var b = '', c = new Uint8Array(a), d = c.byteLength, e = 0;
          d > e;
          e++
        )
      ...
      return (
        ...
        (e.applyExifRotation = function(a) {
          ...
          var f = b.defer();
          return (
            e.readOrientation(a).then(
              function(b) {
                return b.orientation < 2 || b.orientation > 8
                  ? f.resolve(a)
                  : void e.dataUrl(a, !0).then(
                      function(g) {
                        ...
                        (i.onload = function() {
                          try {
                            (h.width = b.orientation > 4 ? i.height : i.width),
                              (h.height =
                                b.orientation > 4 ? i.width : i.height);
                            var g = h.getContext('2d');
                            c(g, b.orientation, i.width, i.height),
                              g.drawImage(i, 0, 0);
                            var j = h.toDataURL(a.type || 'image/WebP', 0.934);
        ...
        (e.restoreExif = function(a, b) {
          ...
          return (
            ...
            (c.restore = function(a, b) {
              a.match('data:image/jpeg;base64,') &&
