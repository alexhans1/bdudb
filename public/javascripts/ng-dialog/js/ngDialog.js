      ...
      function(
        ...
        var privateMethods = {
          ...
          setBodyPadding: function(width) {
            var originalBodyPadding = parseInt(
          ...
          resetBodyPadding: function() {
            var originalBodyPadding = $elements.body.data(
              'ng-dialog-original-padding',
            );
          ...
          closeDialog: function($dialog, value) {
            ...
            if (preCloseCallback && angular.isFunction(preCloseCallback)) {
              var preCloseCallbackResult = preCloseCallback.call(
                $dialog,
                value,
              );
          ...
          handleTab: function($dialog, ev, backward) {
            var focusableElements = privateMethods.getFocusableElements(
              $dialog,
            );
            ...
            var focusIndex = Array.prototype.indexOf.call(
              focusableElements,
              currentFocus,
            );
          ...
          autoFocus: function($dialog) {
            ...
            var contentElements = privateMethods.filterVisibleElements(
          ...
          getFocusableElements: function($dialog) {
            ...
            var rawElements = dialogEl.querySelectorAll(
        ...
        var publicMethods = {
          ...
          open: function(opts) {
            ...
            if (openOnePerName && opts.name) {
              dialogID =
                opts.name.toLowerCase().replace(/\s/g, '-') + '-dialog';
            ...
            $q.all({
              ...
              var hasOverlayClass = options.overlay
                ? ''
                : ' ngdialog-no-overlay';
              $dialog = $el(
                '<div id="' +
                ...
                if (angular.isFunction(options.preCloseCallback)) {
                  ...
                  if (scope) {
                    if (angular.isFunction(scope[options.preCloseCallback])) {
                      ...
                      scope.$parent &&
                      angular.isFunction(
                        scope.$parent[options.preCloseCallback],
                      )
                    ) {
                      preCloseCallback =
                        scope.$parent[options.preCloseCallback];
              ...
              closeByDocumentHandler = function(event) {
                var isOverlay = options.closeByDocument
                  ? $el(event.target).hasClass('ngdialog-overlay')
                  : false;
              ...
              if (typeof $window.Hammer !== 'undefined') {
                var hammerTime = (scope.hammerTime = $window.Hammer(
                  $dialog[0],
                ));
      ...
      return {
        ...
        link: function(scope, elem, attrs) {
          elem.on('click', function(e) {
            ...
            var ngDialogScope = angular.isDefined(scope.ngDialogScope)
              ? scope.ngDialogScope
              : 'noScope';
            angular.isDefined(attrs.ngDialogClosePrevious) &&
            ...
            ngDialog.open({
              ...
              showClose:
                attrs.ngDialogShowClose === 'false'
                  ? false
                  : attrs.ngDialogShowClose === 'true'
                  ? true
                  : defaults.showClose,
              closeByDocument:
                attrs.ngDialogCloseByDocument === 'false'
                  ? false
                  : attrs.ngDialogCloseByDocument === 'true'
                  ? true
                  : defaults.closeByDocument,
              closeByEscape:
                attrs.ngDialogCloseByEscape === 'false'
                  ? false
                  : attrs.ngDialogCloseByEscape === 'true'
                  ? true
                  : defaults.closeByEscape,
              overlay:
                attrs.ngDialogOverlay === 'false'
                  ? false
                  : attrs.ngDialogOverlay === 'true'
                  ? true
                  : defaults.overlay,
              preCloseCallback:
                attrs.ngDialogPreCloseCallback || defaults.preCloseCallback,
