angular
  .module('application', ['cp.ngConfirm'])
  .run([
    '$ngConfirmDefaults',
    ...
    function($scope, $ngConfirm, $interval, $ngConfirmDefaults, $timeout) {
      $scope.materialTheme = function() {
        $ngConfirm({
          ...
          theme: 'material',
          content:
            "<div>Inspirations taken from Google's material design." + '</div>',
          animation: 'scale',
          type: 'purple',
      ...
      $scope.modernTheme = function() {
        $ngConfirm({
          ...
          type: 'blue',
          content:
            '<div class="text-center">This theme meets the trend of the internet.' +
            '</div>',
          animation: 'scale',
          closeAnimation: 'scale',
          buttons: {
      ...
      $scope.supervanTheme = function() {
        $ngConfirm({
          ...
          theme: 'supervan',
          content:
            '<div class="text-center">I was inspired from tumblr for this. <br>' +
      ...
      $scope.alert = function() {
        $ngConfirm({
          ...
          icon: 'fa fa-rocket',
          content:
            '<div>This is a simple alert <br>with some <strong>HTML</strong> contents</div>' +
                ...
                $ngConfirm({
                  ...
                  buttons: {
                    confirm: {
                      ...
                      action: function() {
                        $ngConfirm(
                          'A very critical action <strong>triggered!</strong>',
                        );
                      },
                    },
                    cancel: function() {
        ...
        $ngConfirm({
            ...
            sayMyName: {
              ...
              action: function(scope) {
                $ngConfirm(
                  'Hello <strong>' +
                    scope.username +
                    '</strong>, i hope you have a great day!',
                );
              },
            },
            later: function() {},
          ...
          onScopeReady: function(scope) {
            ...
            scope.textChange = function() {
              if (scope.username) self.buttons.sayMyName.setDisabled(false);
              else self.buttons.sayMyName.setDisabled(true);
            };
          },
        });
      };
      ...
      $scope.autoClose = function() {
        $ngConfirm({
          title: 'Auto close',
          content:
            'Some actions maybe critical, prevent it with the Auto close. This dialog will automatically trigger cancel after the timer runs out.',
      ...
      $scope.keyStrokes = function() {
        $ngConfirm({
          ...
          content:
            'Press the <strong>escape key</strong> to close the modal. That works.' +
      ...
      $scope.centerAlign = function() {
        $ngConfirm({
          ...
          content:
            '<p>You can add content and not worry about the alignment. The goal is to make a Interactive dialog!.</p>' +
        ...
        $ngConfirm({
          ...
          buttons: {
            confirm: {
              ...
              action: function($scope) {
                $scope.images.push(
                  'https://c2.staticflickr.com/6/5248/5240523362_8d6d315391_b.jpg',
                );
                return false; // prevent dialog from closing.
              },
            },
          ...
          onScopeReady: function($scope) {
            $scope.images = [
              'https://c2.staticflickr.com/4/3891/14354989289_2eec0ba724_b.jpg',
            ];
          },
        });
      };
      ...
      $scope.videos = function() {
        $ngConfirm({
          title: $scope.title,
          content:
            '<p> Seamless borders for images or videos!</p> <div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/4kHl4FoK1Ys"></iframe></div>',
          theme: 'seamless',
    ...
    function($scope, $ngConfirm, $interval, $ngConfirmDefaults, $timeout) {
      ...
      $scope.buttonKeysExample = function() {
        $ngConfirm({
          title: false,
          content:
            'A very very critical action here! <br> ' +
    ...
    function($scope, $ngConfirm, $interval, $ngConfirmDefaults, $timeout) {
      ...
      $scope.successDialog = function() {
        $ngConfirm({
          ...
          type: 'green',
          content:
            'Consider something great happened, and you have to show a positive message',
          buttons: {
            thankYou: {
              text: 'Thank you',
              btnClass: 'btn-green',
    ...
    function($scope, $ngConfirm, $interval, $ngConfirmDefaults, $timeout) {
      $scope.deleteUser = function() {
        $ngConfirm({
          title: 'Delete user?',
          content:
            "This dialog will automatically trigger 'cancel' in 6 seconds if you don't respond.",
      ...
      $scope.logoutMyself = function() {
        $ngConfirm({
          title: 'Logout?',
          content:
            'Your time is out, you will be automatically logged out in 10 seconds.',
  ...
  .controller('escapeKeyController', [
    ...
    function($scope, $ngConfirm, $interval, $ngConfirmDefaults, $timeout) {
      $scope.escapeKey = function() {
        $ngConfirm({
          content:
            'background dismiss is not allowed on this modal, thus the modal will make a backgroundDismissAnimation',
          escapeKey: true,
          backgroundDismiss: false,
          buttons: {
            ok: function() {},
      ...
      $timeout(function() {
        if (typeof google_jobrunner == 'undefined' && !localStorage['adsok']) {
          $ngConfirm({
            ...
            theme: 'material',
            content:
              "Ads aren't what you're here for. But ads help me support my work. So, please consider to add this domain to your blocker's whitelist.",
            closeIcon: false,
            buttons: {
              done: {
                text: 'Did it',
              ...
              donate: {
                ...
                action: function() {
                  window.open(
                    'https://www.paypal.me/bonifacepereira',
                    '_blank',
                  );
                  localStorage['adsok'] = true;
                },
