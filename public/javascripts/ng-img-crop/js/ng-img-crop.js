...
(function() {
  ...
  crop.factory('cropAreaCircle', [
    ...
    function(CropArea) {
      ...
      CropAreaCircle.prototype._calcCirclePerimeterCoords = function(
        angleDegrees,
      ) {
      ...
      CropAreaCircle.prototype._isCoordWithinArea = function(coord) {
        return (
          Math.sqrt(
            (coord[0] - this._x) * (coord[0] - this._x) +
              (coord[1] - this._y) * (coord[1] - this._y),
          ) <
          this._size / 2
        );
      };
      CropAreaCircle.prototype._isCoordWithinBoxResize = function(coord) {
        ...
        return (
          coord[0] > resizeIconCenterCoords[0] - hSize &&
          coord[0] < resizeIconCenterCoords[0] + hSize &&
          coord[1] > resizeIconCenterCoords[1] - hSize &&
          coord[1] < resizeIconCenterCoords[1] + hSize
        );
      };
  ...
  crop.factory('cropCanvas', [
    function() {
      ...
      return function(ctx) {
        ...
        // Draw Filled Polygon
        var drawFilledPolygon = function(
          shape,
          fillStyle,
          centerCoords,
          scale,
        ...
        this.drawIconResizeBoxBase = function(centerCoords, boxSize, scale) {
          ...
          ctx.fillRect(
            centerCoords[0] - scaledBoxSize / 2,
            centerCoords[1] - scaledBoxSize / 2,
            scaledBoxSize,
            scaledBoxSize,
          );
          ctx.strokeRect(
      ...
      return function(elCanvas, opts, events) {
        ...
        var resetCropHost = function() {
          if (image !== null) {
            ...
            elCanvas
              .prop('width', canvasDims[0])
              .prop('height', canvasDims[1])
              .css({
            ...
            theArea.setSize(
              Math.min(200, ctx.canvas.width / 2, ctx.canvas.height / 2),
            );
          } else {
            elCanvas
              .prop('width', 0)
        ...
        this.getResultImageDataURI = function() {
          ...
          if (image !== null) {
            temp_ctx.drawImage(
              image,
              (theArea.getX() - theArea.getSize() / 2) *
                (image.width / ctx.canvas.width),
              (theArea.getY() - theArea.getSize() / 2) *
